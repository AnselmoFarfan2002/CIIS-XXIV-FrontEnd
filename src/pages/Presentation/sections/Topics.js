            ...
            <Grid container spacing={3} sx={{ mt: { xs: 0, md: 6 } }}>
              <Grid item xs={12} md={6}>
                <DefaultInfoCard
                  ...
                  description="Explora el campo de la teledetección (remote sensing) y el Internet de las cosas (IoT) y cómo se utilizan para recopilar datos en tiempo real y obtener información sobre nuestro entorno. Aprende sobre las aplicaciones de la teledetección y el IoT en diferentes industrias y sectores."
                />
              </Grid>
            </Grid>
          </Grid>
